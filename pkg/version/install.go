...
import (
	"fmt"
	"github.com/Benbentwo/SystemInfo/pkg/github"
...
func (o *VersionOptions) InstallBin(upgrade bool, prefix string, version string) error {
	...
	// BinaryDownloadBaseURL := "https://github.com/Benbentwo/SystemInfo/releases/download/v1.0.0/
	// 							 https://github.com/Benbentwo/SystemInfo/releases/download/v1.0.0/go-bin-generic-windows-amd64.zip"
